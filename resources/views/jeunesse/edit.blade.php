...
@section('content')
  ...
  @php
    $fieldException=[];
  @endphp
      <h4 class="tittle-w3-agileits mb-4">MODIFIER UN MEMBRE DE LA JEUNESSE</h4>
      <form action="{{route('jeunesse_update',$membre)}}" method="post">
        @csrf
          ...
          <fieldset class="form-group">
              ...
              <input hidden type="text" name="association_id" value="2">
          <div class="form-group row">
              <div class="col-sm-10">
