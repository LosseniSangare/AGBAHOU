...
@section('content')
  ...
  @include('layout._navSource')
      ...
      <h4 class="tittle-w3-agileits mb-4">AJOUTER UN MEMBRE SOURCE</h4>
        ...
        @csrf
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-10">
                  ...
                  {!! $errors->first('filiere','<span style="color:red">:message</span>') !!}
              </div>
          </div>
          <div class="form-group row">
              ...
              <div class="col-sm-10">
                  ...
                  {!! $errors->first('niveau','<span style="color:red">:message</span>') !!}
              </div>
          </div>
