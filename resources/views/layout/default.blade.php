...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, Sony Ericsson, Motorola web design" />
    ...
    <!-- Bootstrap Css -->
    <!-- Bootstrap Css -->
    <link rel="stylesheet" href="{{asset('web/css/bar.css')}}">
    <!-- Bars Css -->
    <!--// Bars Css -->
    <link rel="stylesheet" type="text/css" href="{{asset('web/css/pignose.calender.css')}}" />
    <!-- Calender Css -->
    <!--// Calender Css -->
    <link href="{{asset('web/css/style.css')}}" rel="stylesheet" type="text/css" media="all" />
    <!-- Common Css -->
    <!--// Common Css -->
    <link rel="stylesheet" href="{{asset('web/css/style4.css')}}">
    <!-- Nav Css -->
    <!--// Nav Css -->
...
<body>
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                <li class="active">
                    ...
                    <li>
                        <a href="{{route('acceuil_presentation')}}">
                            <i class="fas fa-chart-pie"></i>
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="homeSubmenu">
                      <li>
                          <a href="{{route('muda_index')}}">MUDA</a>
                      </li>


                        <li>
                            <a href="{{route('f3add_index')}}">F3ADD</a>
                        </li>

                        <li>
                            <a href="{{route('source_index')}}">SOURCE</a>
                        </li>
                        <li>
                            <a href="{{route('jeunesse_index')}}">ASSOCIATION DE LA JEUNESSE</a>
                        </li>

                        <li>
                            <a href="{{route('femme_index')}}">ASSOCIATION DES FEMMES</a>
                        </li>
        ...
        <div id="content">
            ...
            <div class="copyright-w3layouts py-xl-3 py-2 mt-xl-5 mt-4 text-center">
                <p>© 2018 AGBAOU. Tous droits reserve<p>
    ...
    <script src="{{asset('web/js/pignose.calender.js')}}"></script>
    {{-- <script> --}}
        //<![CDATA[
        $(function () {
